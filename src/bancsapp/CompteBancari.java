...
public class CompteBancari {
    ...
    private static float saldoInicial = 100; // Saldo inicial de 100€
    private float saldo;
    ...
    // Mètode per a la salutació personalitzada
    public String saludo() {
        return "Hola! Benvingut al banc, " + this.nom + "!";
    }

    // Mètode per a la salutació genèrica
    public String saludo2() {
        return "Hola! Benvingut al banc!";
    }
}